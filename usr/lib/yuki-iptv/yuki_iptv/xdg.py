...
def get_cache_dir():
    if sys.platform == "win32":
        ...
        cache_dir = str(Path(base, "yuki-iptv"))
    elif "XDG_CACHE_HOME" in os.environ and os.environ["XDG_CACHE_HOME"]:
...
def get_config_dir():
    if sys.platform == "win32":
        config_dir = os.environ.get("APPDATA") or str(Path.home())
    elif "XDG_CONFIG_HOME" in os.environ and os.environ["XDG_CONFIG_HOME"]:
