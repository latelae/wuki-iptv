...
if sys.platform == "win32":
    ...
    # Prevent display/system sleep while playing
    ...
    def inhibit():
        try:
            ...
            logger.warning("SetThreadExecutionState inhibit failed")
    ...
    def uninhibit():
        try:
            ...
            logger.warning("SetThreadExecutionState uninhibit failed")
            logger.warning(traceback.format_exc())
